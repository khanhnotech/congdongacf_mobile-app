...
export const useTrendingPosts = ({ pageSize = DEFAULT_PAGE_SIZE } = {}) => {
  const listQuery = useInfiniteQuery({
    queryKey: [...QUERY_KEYS.POSTS.TREND, pageSize],
    queryFn: ({ pageParam = 1 }) =>
      postsService.listTrendingPosts({ page: pageParam, limit: pageSize }),
    initialPageParam: 1,
