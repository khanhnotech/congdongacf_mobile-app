...
const TestResponsiveScreen = () => {
  const { rw, rh, rf, isSmall, isMedium, isLarge, screenSize } = useResponsive();
        ...
        <ResponsiveContainer>
          ...
          >
            ...
            <ResponsiveText
              ...
              style={{ marginTop: 8 }}
            >
              Screen Size: {screenSize} ({isSmall ? 'Small' : isMedium ? 'Medium' : isLarge ? 'Large' : 'Extra Large'})
            </ResponsiveText>
            <ResponsiveText
              size="sm"
              color="#999"
              ...
              style={{ marginTop: 4 }}
            >
              Width: {rw(390)}px | Height: {rh(844)}px
            </ResponsiveText>
          </ResponsiveView>
          ...
          >
            ...
            <ResponsiveText
              ...
              style={{ marginBottom: 8 }}
            >
              This is large body text that scales with screen size.
            </ResponsiveText>
          ...
          {/* Test with useResponsiveSpacing hook */}
          <ResponsiveView
            backgroundColor="#FFFFFF"
            padding={20}
            borderRadius={12}
          ...
          >
            <ResponsiveText
              ...
              style={{ marginBottom: 16 }}
            >
              useResponsiveSpacing Hook Test
            </ResponsiveText>
            ...
            <ResponsiveText
              ...
              style={{ marginBottom: 8 }}
            >
              This section tests the existing useResponsiveSpacing hook compatibility.
            </ResponsiveText>
...
export default TestResponsiveScreen;
